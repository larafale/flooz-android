...
public class SponsorActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.controller = new SponsorController(this.findViewById(android.R.id.content), this, NotificationsController.ControllerKind.ACTIVITY_CONTROLLER, triggerData);
    }
