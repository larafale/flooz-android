...
public class ShopHistoryActivity extends BaseActivity {
    ...
    private ShopHistoryController controller;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.setContentView(R.layout.shop_history_fragment);
        ...
        this.controller = new ShopHistoryController(this.findViewById(android.R.id.content), this, BaseController.ControllerKind.ACTIVITY_CONTROLLER, triggerData);
    }
