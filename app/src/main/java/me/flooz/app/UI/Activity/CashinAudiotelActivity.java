 ...
 */
public class CashinAudiotelActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.setContentView(R.layout.cashin_audiotel_activity);
        ...
        this.infosTextview = (TextView) this.findViewById(R.id.cashin_audiotel_infos);
        this.numberImage = (ImageView) this.findViewById(R.id.cashin_audiotel_img);
        this.avalaibleTextview = (TextView) this.findViewById(R.id.cashin_audiotel_avalaible);
        this.hintTextview = (TextView) this.findViewById(R.id.cashin_audiotel_hint);
        this.codeTextfield = (EditText) this.findViewById(R.id.cashin_audiotel_code);
        this.sendButton = (Button) this.findViewById(R.id.cashin_audiotel_button);
