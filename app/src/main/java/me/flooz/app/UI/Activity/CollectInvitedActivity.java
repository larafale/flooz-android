 ...
 */
public class CollectInvitedActivity extends BaseActivity {
    private CollectInvitedController controller;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.setContentView(R.layout.collect_invited_fragment);
