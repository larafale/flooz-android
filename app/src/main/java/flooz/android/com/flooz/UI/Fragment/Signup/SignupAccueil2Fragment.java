 ...
 */
public class SignupAccueil2Fragment extends SignupBaseFragment {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.signup_accueil2_fragment, null);

        TextView title1 = (TextView)view.findViewById(R.id.signup_accueil_2_title_1);
        TextView title2 = (TextView)view.findViewById(R.id.signup_accueil_2_title_2);
        TextView title3 = (TextView)view.findViewById(R.id.signup_accueil_2_title_3);

        TextView subtitle1 = (TextView)view.findViewById(R.id.signup_accueil_2_subtitle_1);
        TextView subtitle2 = (TextView)view.findViewById(R.id.signup_accueil_2_subtitle_2);
        TextView subtitle3 = (TextView)view.findViewById(R.id.signup_accueil_2_subtitle_3);

        Button button = (Button)view.findViewById(R.id.signup_accueil_2_button);
